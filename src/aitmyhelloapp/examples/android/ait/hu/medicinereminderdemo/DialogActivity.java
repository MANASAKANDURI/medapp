...
public class DialogActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final String date = new StringBuilder().append(year).append(pad(month)).append(pad(day)).toString();
		...
		yes.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (!sp.getString("phone_number", "").equals("")) {
					Toast.makeText(DialogActivity.this, "Sending Msg To Phone : " + sp.getString("phone_number", ""),
							Toast.LENGTH_SHORT).show();
					
					smsManager.sendTextMessage(sp.getString("phone_number", ""), null,
							"Your friend has taken their medicine...", null, null);
				}
				finish();
			}
		});
		...
		no.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (!sp.getString("phone_number", "").equals("")) {
					...
					smsManager.sendTextMessage(sp.getString("phone_number", ""), null,
							"Your friend has not taken their medicine! Please remind them!", null, null);
				}
				finish();
			}
		});
